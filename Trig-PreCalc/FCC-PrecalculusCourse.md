...
## 2025-December-24 - Functions :
https://www.youtube.com/watch?v=eI4an8aSsgw&t=20
- Definition. A function is correspondence between input numbers (x-values) and out-put numbers (y-value) that sends each input number (x-value) to exactly one output number (y-value).
...
https://www.youtube.com/watch?v=eI4an8aSsgw&t=2h30m15s
